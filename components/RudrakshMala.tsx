...
export default function RudrakshMala() {
  ...
  return (
    <div className="relative w-full max-w-[450px] aspect-square flex items-center justify-center p-8">
      ...
      {/* Center Maharshi Icon (Strictly Stationary) */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-52 h-52 rounded-full flex items-center justify-center overflow-hidden border-2 border-secondary/40 bg-gradient-to-b from-[#1a1528] to-[#0a0d22] shadow-[0_0_50px_rgba(255,193,7,0.2)]"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,193,7,0.15)_0%,transparent_70%)]" />
        <Image
          src="/maharshi.png"
          alt="Maharshi Meditating"
          width={150}
          height={150}
          className="object-contain drop-shadow-[0_0_15px_rgba(255,193,7,0.4)]"
